...
image =cv2.circle(image, (300, 300), radius, color, thickness=-1, lineType=cv2.LINE_AA)
image =cv2.circle(image, (500, 500), radius, [255, 0, 0], thickness=-1, lineType=cv2.LINE_AA)
image =cv2.circle(image, (650, 650), radius, [0, 255, 0], thickness=-1, lineType=cv2.LINE_AA)
image =cv2.circle(image, (150, 150), radius, [255, 255, 255], thickness=-1, lineType=cv2.LINE_AA)
image =cv2.circle(image, (800, 800), radius, (255, 255, 255), thickness=-1, lineType=cv2.LINE_AA)

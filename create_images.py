...
bartosz_path = '/Users/s932172@aics.espritscholen.nl/Desktop/game development/cv development/6lesson/dataset/Bartosz'

path = os.path.join(dataset_path, bartosz_path)
